    ...
    navbarPage(theme = shinytheme("cerulean"),
               ...
               tabPanel("Tx Renal", icon = icon("heartbeat"),
                      ...
                      a(href="http://repositorio.insa.pt/bitstream/10400.18/4713/1/Boletim_Epidemiologico_Observacoes_N18_2017_artigo5.pdf", 
                        target = "_blank",
                        h6("Evolução da atividade de transplantação renal em Portugal: dados públicos de 2003 a 2015")
                      ),
                      sidebarPanel(
                        conditionalPanel(
                          'input.rim === "Gráficos"',
             ...
             navbarMenu("cPRA",
                     tabPanel("calculador", icon = icon("calculator"),
                              ...
                              h3("Percentual de Transplantabilidade (%T):"),
                              h4("Seleccione grupo sanguíneo (e volte a 'Calcular'):"),
                              radioButtons("ab0", "grupo AB0:",
                                           c("A" = 0.466,
                                             "B" = 0.0769,
                                             "AB" = 0.0343,
                                             "0" = 0.4228), inline = T),
                     ...
                     tabPanel("Nota técnica", icon = icon("sticky-note"),
                              ...
                              p("O valor percentual de Transplantabilidade (%T), aqui apresentado, devolve a percentagem de possíveis dadores que são AB0 idênticos (distribuição isogrupal) e têm antigénios HLA aceitáveis pelo potencial candidato."),
                              p("Para o cálculo deste estimador %T foram utilizadas as frequências de grupos sanguíneos, previamente descritas para dadores de sangue em Portugal [5]."),
