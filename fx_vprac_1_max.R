...
vprac_1<-function(id = 1, sensib = acHLA,
  ...
  max(1-(1-Sa)^2,1-(1-Sc)^2,1-(1-Sb)^2,1-(1-Sdr)^2,
      1-(1-Sa-Sc+Sac)^2,1-(1-Sa-Sb+Sab)^2,1-(1-Sc-Sb+Scb)^2,1-(1-Sa-Sdr+Sadr)^2,1-(1-Sb-Sdr+Sbdr)^2,1-(1-Sc-Sdr+Scdr)^2,
      1-(1-Sa-Sc-Sb+Sac+Sab+Scb-Sacb)^2,1-(1-Sa-Sc-Sdr+Sac+Sadr+Scdr-Sacdr)^2,1-(1-Sa-Sdr-Sb+Sadr+Sab+Sbdr-Sabdr)^2,1-(1-Sdr-Sc-Sb+Scdr+Sbdr+Scb-Scbdr)^2,
      vpraf)
